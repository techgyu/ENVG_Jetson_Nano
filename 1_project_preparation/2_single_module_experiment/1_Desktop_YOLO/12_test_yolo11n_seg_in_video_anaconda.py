...
# 입력 이미지 폴더 경로
img_dir = "1_project_preparation/2_single_module_experiment/1_Desktop_YOLO/data/12_test_yolo11n_seg_in_video_anaconda/input"
# 결과 저장 폴더 경로
out_dir = "1_project_preparation/2_single_module_experiment/1_Desktop_YOLO/data/12_test_yolo11n_seg_in_video_anaconda/yolo_output"
