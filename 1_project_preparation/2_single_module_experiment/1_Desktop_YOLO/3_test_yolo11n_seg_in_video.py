...
# 입력 이미지 폴더 경로
img_dir = "1_project_preparation/2_single_module_experiment/1_Desktop_YOLO/data/3_test_yolo11n_segmentation_in_video/input"
# 결과 저장 폴더 경로
out_dir = "1_project_preparation/2_single_module_experiment/1_Desktop_YOLO/data/image/yolo_output"
