...
input_dir = "1_project_preparation/2_single_module_experiment/1_Desktop_YOLO/data/7_test_yolo11n_seg_in_video_docker/yolo_output"
# 저장할 영상 파일 경로
output_video = "1_project_preparation/2_single_module_experiment/1_Desktop_YOLO/data/8_intergrate_frame_to_video_docker/yolo_output_video.mp4"
