...
results = model("C:/github_personal/ENVG_Jetson_Nano/1_project_preparation/2_single_module_experiment/1_Desktop_YOLO/data/11_test_yolo11n_seg_anacodna",
    show_boxes=False
)
...
for i, result in enumerate(results):
    if result.masks is not None and result.names is not None:
        # 원본 이미지 불러오기
        img = cv2.imread("C:/github_personal/ENVG_Jetson_Nano/1_project_preparation/2_single_module_experiment/1_Desktop_YOLO/data/11_test_yolo11n_seg_anacodna/bus.jpg")
